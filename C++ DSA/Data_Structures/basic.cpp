...
void explainVectors()
{
    ...
    for (auto it : v)
    { // automatacally takes as int data type and iterate vector
        cout << it << endl;
    }
    ...
    for (auto it : v)
    { // printing above modified vector
        cout << it << endl;
    }
...
void Studylist()
{
    ...
    for (auto it : ls)
    { // automatacally takes as int data type and iterate list
        cout << it << endl;
    }
...
void Studyset()
{
    ...
    st.erase(5); // takes logrithmic[O(log(n))] time
